...
const AddReport = () => {
  ...
  const createReport = async (e) => {
    ...
    try {
      await fetchCreateReport(title, location, description, password);
      history('/reports');
    } catch (error) {
  ...
  return (
    <section className="font-robotomono lowercase tracking-[4px] sm:mt-20">
      <div className="max-w-screen-xl px-4 py-4 mx-auto sm:px-6 lg:px-2">
        <div className="grid grid-cols-1 gap-x-16 gap-y-8 lg:grid-cols-5">
          <div className="lg:col-span-2 lg:py-12">
            <p className="max-w-xl sm:text-lg leading-4">
            ...
            <div className="mt-8">
              <p className="sm:text-2xl font-bold text-white blur-[1px] animate-pulse">
                Reports are anonymous and open for 24 hours
              </p>
            </div>
          </div>

          <div className="sm:p-8 rounded-lg shadow-lg lg:col-span-3 lg:p-12">
